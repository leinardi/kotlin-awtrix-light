...
class NotificationTest : DIAware {
    ...
    fun `Test serialization and deserialization`() {
        val notification = Notification(
            ...
            progressBC = "#ff0000",
            draw = listOf(
                Draw.Circle(28, 4, 3, "#FF0000"),
                Draw.FilledCircle(28, 4, 3, "#FF0000"),
                Draw.Rectangle(20, 4, 4, 4, "#0000FF"),
                Draw.FilledRectangle(20, 4, 4, 4, "#0000FF"),
                Draw.Text(0, 0, "Hello", "#00FF00"),
                Draw.Pixel(0, 0, "#00FF00"),
            ),
            stack = true,
            wakeup = true,
            noScroll = true,
